...
public class MainActivity extends DetachActivity {
  ...
  public String publishedUrl() {
    return "exp://exp.host/@bacon/bute";
  }
  ...
  public List<Package> expoPackages() {
    ...
    return Arrays.<Package>asList(new FirebaseAppPackage(), new FirebaseAnalyticsPackage(), new FirebaseAuthPackage(),
        // new FirebaseCrashlyticsPackage(),
        new FirebaseDatabasePackage(), new FirebaseFirestorePackage(),
        // new FirebaseFunctionsPackage(),
        new FirebaseInstanceIDPackage(),
        // new FirebaseInvitesPackage(),
        // new FirebaseLinksPackage(),
        new FirebaseMessagingPackage(), new FirebaseNotificationsPackage(), new FirebasePerformancePackage(),
